...
// 	this.label = new THREE.TextGeometry(filepath);
// 	this.object.add(this.label);

// 	// var defaultImg = THREE.ImageUtils.loadTexture('http://upload.wikimedia.org/wikipedia/commons/7/79/Sea_otters_holding_hands.jpg');
